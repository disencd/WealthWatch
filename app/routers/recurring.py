...
from app.models import RecurringFrequency, RecurringTransaction
    ...
    rows = (
        (
            await db.execute(
                ...
                .where(RecurringTransaction.family_id == current_user.family_id)
...
async def update_recurring(
    ...
    if req.merchant is not None:
        r.merchant = req.merchant
    if req.amount is not None:
        r.amount = req.amount
    if req.frequency is not None:
        r.frequency = RecurringFrequency(req.frequency)
    if req.next_due_date is not None:
        r.next_due_date = datetime.fromisoformat(req.next_due_date)
